<%@ Page Title="" Language="C#" MasterPageFile="~/HeaderFooter.Master" AutoEventWireup="true" Inherits="registration" Codebehind="registration.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="LeftPanelHolder" runat="server"> <H1>Why ExamCrazy</H1>
</asp:Content>
                        ...
                        <div style="padding-top: 25px;">
                            ...
                            <table border="0" cellpadding="2" align="left" cellspacing="2" width="100%">
                              ...
                              <tr>
                                ...
                                <td width="74%" valign="top">
                                    <div style="margin-bottom: 6px">
                                        <asp:RadioButtonList ID="RadioButtonSex" RepeatColumns="2" RepeatDirection="Horizontal" runat="server">
