...
namespace EC.BL
{
    ...
    public sealed class Blogic
   {
        ...
        public IDataReader GetCityList(int StateID)
        {
            SqlParameter prmID = new SqlParameter("@StateID", SqlDbType.Int, 4);
            prmID.Value = StateID;
            return DataAccess.GetFromReader("spSelectCityList", prmID);
        }

        public static int AddNewCity(string name, int CityID)
        {
            return 0;
        }
...
#region Users Membership and Site Configuration
      ...
      /// Get UserEmail
      /// </summary>
      public static string GetUserEmail(string UserName, string Paswword)
      {
          SqlParameter prmUserName = new SqlParameter("@Username", SqlDbType.VarChar, 50);
          prmUserName.Value = UserName;
          ...
          return DataAccess.GetString("spGetUserEmail", prmUserName, prmPaswword);
      }
