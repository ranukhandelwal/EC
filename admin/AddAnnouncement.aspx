<%@ Page Title="" Language="C#" MasterPageFile="~/AdminFeed.master" AutoEventWireup="true" CodeBehind="AddAnnouncement.aspx.cs" Inherits="ExamCrazy.admin.AddAnnouncement" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="MainContent" runat="server">
    <div style="margin-left: 28px; margin-right: 20px; margin-top: 5px; background-color: #fff;
        ...
        <fieldset>
            <legend>New Announcement Form</legend>
                ...
                <table border="0" cellpadding="2" align="left" cellspacing="2" width="100%">
                    ...
                    <tr>
                        ...
                        <td width="74%" valign="top">
                            <div style="margin-bottom: 6px">
                                <input type="text" id="AnnounceTitle" name="AnnounceTitle" class="txtinput" size="80" runat="server"
                                ...
                                <br />
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldUname" ControlToValidate="AnnounceTitle"
                    ...
                    <tr>
                        <td width="15%" valign="top">
                            <div style="margin-bottom: 6px">
                                <span class="content12">Next Date:</span><span class="cred2"><br>Example last date</span></div>
                        </td>
                        <td width="74%" valign="top">
                            <div style="margin-bottom: 6px">
                                <input type="text" id="NextDate" name="NextDate" class="txtinput" size="80" runat="server"
                                    onkeypress="return ValidateText(event)" onmouseover="Tip('Use this to give info like last date @.', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')"
                                    onmouseout="UnTip()" onfocus="this.style.backgroundColor='#FFFBE1'" onblur="this.style.backgroundColor='#ffffff'"
                                    value="Title/Post Name" />&nbsp;<span id="Span1"></span>
                                <br />
