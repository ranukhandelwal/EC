...
{
    public partial class JMET_participating_MBA_institutes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title ="JMET 2009 Participating Institutes Joint Management Entrance Test - examcrazy.com";
HtmlMeta metaTag = new HtmlMeta();
metaTag.Name =  "MBA, Management, Master in Business Applications, JMET mock test, free MBA preparation, MBA mock tests, Ministry of HRD, Masters in India, MBA colleges, post engineering colleges in India, Management Courses, MBA admissions 2009, sample questions, MBA in India, Ranking of MBA institutes, XLRI Jamshedpur, GMAT score accepted, JMET 2008, JMET 2009, Joint Management Entrance Test , IIT management Admission Test, JMET IMPORTANT DATES,  Last Date for Registration, JMET exam date, JMET Bulletin, Prospectus, JMET dates, JMET syllabus, JMET preparation, JMET practice tests, how to apply,  JMET ELIGIBILITY, JMET online practice, Participating Institutes JMET 2009.";
