...
{
    public partial class CAT_syllabus : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title ="CAT Syllabus MBA in India - examcrazy.com";
...
metaTag.Content="Free MBA exam preparation and MBA admissions CAT, CAT, IBSAT, SNAP, GMAT and others. Practice tests,  Tips and Tricks for MBA preparation, Syllabus for CAT, Profile of MBA colleges, MBA admissions, Recommended books and study CATerial";
