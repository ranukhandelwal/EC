...
{
    public partial class CAT_Sample_test_section3 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title ="CAT ELIGIBILITY MBA in India - examcrazy.com";
...
metaTag.Content="Free MBA exam preparation and MBA admissions CAT, CAT, IBSAT, SNAP, GMAT and others. Practice tests,  Tips and Tricks for MBA preparation, eligibility for CAT, Profile of MBA colleges, MBA admissions, Recommended books and study CATerial";
