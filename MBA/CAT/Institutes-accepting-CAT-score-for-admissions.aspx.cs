...
{
    public partial class Institutes_accepting_CAT_score_for_admissions : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title ="NON-IIM Institutes accepting CAT 2008 Scores for MBA admissions - examcrazy.com";
...
metaTag.Content="Free MBA exam preparation and MBA admissions CAT, CAT, IBSAT, SNAP, GMAT and others. Practice tests, Tips and Tricks for MBA preparation, Profile of MBA colleges, MBA admissions, Recommended books and study CATerial";
