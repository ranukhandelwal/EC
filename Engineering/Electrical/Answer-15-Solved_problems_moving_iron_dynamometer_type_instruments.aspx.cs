...
{
    public partial class Answer_15_Solved_problems_moving_iron_dynamometer_type_instruments : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title ="Answer 15 for Problems on Moving type and dynamometer type instruments by Prof Sunil Kumar - Electrical Engineering - examcrazy.com";
HtmlMeta metaTag = new HtmlMeta();
metaTag.Name =  "Electrical Engineering, Electrical, Prof Sunil Kumar, IES College, Greater Noida,  Indian Engineering Services, UPSC, IES, GATE, GATE Electrical, DRDO-SET Electrical,  Solved Problems, Moving type instruments, dynamometer type instruments, moving coil instruments, energy meter, revolutions, free electrical practice tests.";
