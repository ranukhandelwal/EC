...
{
    public partial class Answer_10_Solved_problems_moving_iron_dynamometer_type_instruments : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title ="Answer 10 for Problems on Moving type and dynamometer type instruments by Prof Sunil Kumar - Electrical Engineering - examcrazy.com";
HtmlMeta metaTag = new HtmlMeta();
metaTag.Name =  "Electrical Engineering, Electrical, Prof Sunil Kumar, IES College, Greater Noida,  Indian Engineering Services, UPSC, IES, GATE, GATE Electrical, DRDO-SET Electrical,  Solved Problems, Moving type instruments, dynamometer type instruments, indicating, recording, integrating, revolutions, free electrical practice tests.";
