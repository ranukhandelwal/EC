...
{
    public partial class Machine_Design_Engine_parts_Problems_Numericals : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title ="Engine parts - Numericals, objective subjective Problems & mini projects on Machine Design - Mechanical Engineering - examcrazy.com";
...
metaTag.Content="Engine parts - Problems, Numericals & mini projects on Machine Design, Mechanical Engineering articles, solved numericals, questions, objective type papers, GATE, IES practice tests. Visit us for many more such articles for all engineering and MBA related exams.";
