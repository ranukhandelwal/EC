...
{
    public partial class Machine_Design_Spur_Gears_Helical_gears_Problems_Numericals : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title ="Spur Gears & Helical gears - Problems, Numericals & mini projects on Machine Design - Mechanical Engineering - examcrazy.com";
...
metaTag.Content="Spur Gears & Helical gears - Problems, Numericals & mini projects on Machine Design, Mechanical Engineering articles, solved numericals, questions, objective type papers, GATE, IES practice tests. Visit us for many more such articles for all engineering and MBA related exams.";
