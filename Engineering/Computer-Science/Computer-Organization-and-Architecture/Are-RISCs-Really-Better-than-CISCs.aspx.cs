...
{
    public partial class Are_RISCs_Really_Better_than_CISCs : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title =" Are RISCs Really Better than CISCs- ExamCrazy.Com";
HtmlMeta metaTag = new HtmlMeta();
metaTag.Name =  " Are RISCs Really Better than CISCs ";
