...
{
    public partial class Performance_of_Parallel_Architectures : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title =" Performance of Parallel Architectures- ExamCrazy.Com";
HtmlMeta metaTag = new HtmlMeta();
metaTag.Name =  " Performance of Parallel Architectures ";
