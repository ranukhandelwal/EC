...
{
    public partial class A_Solution_Parallel_Computers : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title =" A Solution: Parallel Computers- ExamCrazy.Com";
HtmlMeta metaTag = new HtmlMeta();
metaTag.Name =  " A Solution: Parallel Computers ";
