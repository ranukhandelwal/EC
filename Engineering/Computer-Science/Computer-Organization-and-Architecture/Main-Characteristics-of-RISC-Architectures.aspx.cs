...
{
    public partial class Main_Characteristics_of_RISC_Architectures : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title =" Main Characteristics of RISC Architectures- ExamCrazy.Com";
HtmlMeta metaTag = new HtmlMeta();
metaTag.Name =  " Main Characteristics of RISC Architectures ";
