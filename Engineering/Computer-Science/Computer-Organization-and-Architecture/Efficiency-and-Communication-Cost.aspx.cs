...
{
    public partial class Efficiency_and_Communication_Cost : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title =" Efficiency and Communication Cost- ExamCrazy.Com";
HtmlMeta metaTag = new HtmlMeta();
metaTag.Name =  " Efficiency and Communication Cost ";
