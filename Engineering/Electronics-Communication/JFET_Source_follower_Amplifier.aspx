<%@ Page Language="C#" MasterPageFile="~/Masters/ec2links.master" AutoEventWireup="True" CodeBehind="JFET_Source_follower_Amplifier.aspx.cs"  Inherits="ExamCrazy.Engineering.Electronics_Communication.JFET_Source_follower_Amplifier" %>
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image1.gif"></sub>
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image2.gif"></sub>
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image3.gif"></sub>
<br>The slope of this drain current versus V<sub>gs</sub> is called the transconductance g<sub>m</sub> of the JFET: 
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image4.gif"></sub>
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image5.gif"></sub>
<br>This curve is simply a straight line, as shown in
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image6.gif"></sub>
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image7.gif"></sub>
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image8.gif"></sub>
...
<br>Referring to
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image9.gif"></sub>
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image10.gif"></sub>
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image11.gif"></sub>
<br>Now, solving for the ratio of output to input voltage, we find
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image12.gif"></sub>
<br>Or 
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image13.gif"></sub>
...
<br>
    ...
    <tr>
      ...
      <td class="txt">
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
</td>

      
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink2" runat="server" Text="<b>fourier transform</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
<br>sir,
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink3" runat="server" Text="<b>Fourier Transform</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink4" runat="server" Text="<b>fourier transform</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
<br>sir i want tutorial on fourier transform 
<br>
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink5" runat="server" Text="<b>match filter</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink6" runat="server" Text="<b>Electic circuits</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink7" runat="server" Text="<b>electro statics</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink8" runat="server" Text="<b>electromagnetic waves</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink9" runat="server" Text="<b>oscillators</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink10" runat="server" Text="<b>Equivalent circuit Models</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink11" runat="server" Text="<b>temperature Vs reverse satuation current</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink12" runat="server" Text="<b>communication system</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink13" runat="server" Text="<b>CMOS TRANSISTOR</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image14.gif"></sub>
      ...
      <td class="txt">
	<br><asp:HyperLink ID="HyperLink14" runat="server" Text="<b>coaching in ies in indore</b>" NavigateUrl="~/engineering/electronics-communication/jfet_source_follower_amplifier.aspx"></asp:HyperLink> 
...
<br>Username: 
      ...
      <td class="txt">
	<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image15.wmf"></sub>
</td>
</tr>
...
<br></td>
    ...
    <tr>
      ...
      <td class="txt">
<br><b>Login-Id</b>
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image16.wmf"></sub>
</td>
...
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image16.wmf"></sub>
      ...
      <td class="txt">
	<br>
<br><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image15.wmf"></sub><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image15.wmf"></sub><sub><img src="/Engineering/Electronics-Communication/img_jfet_source_follower_amplifier/image15.wmf"></sub>
</td>
</tr></table>
<br>
</td>
