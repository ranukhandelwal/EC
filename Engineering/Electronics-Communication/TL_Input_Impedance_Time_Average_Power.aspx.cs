...
{
    public partial class TL_Input_Impedance_Time_Average_Power : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
Page.Header.Title ="TL Input Impedance Time Average Power Return and Insertion Losses- ExamCrazy.Com";
