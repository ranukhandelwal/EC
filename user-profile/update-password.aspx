        ...
        <table border="0" cellpadding="2" align="left" cellspacing="2" width="100%">
            <tr>
                <td width="15%" valign="top" colspan="2">
                    <asp:Label ID="lblupdatepswd" runat="server"></asp:Label>
                </td>
            </tr>
            <asp:Panel ID="pnldefault" Visible="false" runat="server">
                <tr>
            ...
            <asp:Panel ID="pnlActivation" Visible="false" runat="server">
                <tr>
                    <td width="15%" valign="top">
                        <div style="margin-bottom: 6px">
                ...
                <tr>
                    <td width="15%" valign="top" colspan="2">
                        <asp:ValidationSummary ID="UpdatePwd" runat="server" EnableClientScript="true" ShowMessageBox="true"
                            ShowSummary="false" HeaderText="The following fields need attention:" />
